( function () {
	function initSlider( root ) {
		var track = root.querySelector( '.jcs-hs-track' );
		var slides = [].slice.call( track.querySelectorAll( '.jcs-hs-slide' ) );
		var prev = root.querySelector( '.jcs-hs-prev' );
		var next = root.querySelector( '.jcs-hs-next' );
		var dashTrack = root.querySelector( '.jcs-hs-dash-track' );
		...
		slides.forEach( function () {
			...
			d.className = 'jcs-hs-dash';
			var span = document.createElement( 'span' );
			span.style.background = dashColor;
			d.appendChild( span );
			dashTrack.appendChild( d );
		} );
		var dashes = [].slice.call( dashTrack.querySelectorAll( '.jcs-hs-dash' ) );
	...
	function initAll() {
		document.querySelectorAll( '.jcs-hero-slider' ).forEach( function ( root ) {
