(function(){
  ...
  function slideMarkup(s, i){
    ...
    return '\n    <article class="csx-slide '+instanceId+'-slide'+(i===0?' is-active':'')+'" data-slide="'+i+'" style="background-color:'+(s.bgColor||'#0a0a0a')+';">\n' +
      ...
      '          <span class="csx-eyebrow" style="background:'+(s.eyebrowBgEnabled===false?'transparent':'rgba('+hexRgb(s.eyebrowBg)+','+(s.eyebrowOpacity/100)+')')+'!important;color:'+s.eyebrowColor+'!important;padding:'+s.eyebrowPadY+'px '+s.eyebrowPadX+'px!important;font-family:'+s.eyebrowFont+',sans-serif!important;font-weight:'+s.eyebrowWeight+'!important;font-size:'+s.eyebrowSize+'px!important;line-height:1.05!important;letter-spacing:'+s.eyebrowLetterSpacing+'px!important;transform:translate('+s.eyebrowShiftX+'px,'+s.eyebrowShiftY+'px)!important;--jcs-m-size:'+mEyebrowSize+'px;--jcs-m-letter:'+s.mobileEyebrowLetterSpacing+'px;--jcs-m-shiftx:'+s.mobileEyebrowShiftX+'px;--jcs-m-shifty:'+s.mobileEyebrowShiftY+'px;border-radius:'+s.eyebrowRadius+'px;box-shadow:'+eyebrowShadow+';margin-bottom:'+s.gapEyebrow+'px;--jcs-m-gap:'+mGapEyebrow+'px;">'+esc(s.eyebrow)+'</span>\n' +
      '          <div role="heading" aria-level="2" class="csx-heading" style="color:'+s.headingColor+'!important;font-family:'+s.headingFont+',sans-serif!important;font-weight:'+s.headingWeight+'!important;font-size:'+s.headingSize+'px!important;letter-spacing:'+s.headingLetterSpacing+'px!important;transform:translate('+s.headingShiftX+'px,'+s.headingShiftY+'px)!important;--jcs-m-letter:'+s.mobileHeadingLetterSpacing+'px;--jcs-m-shiftx:'+s.mobileHeadingShiftX+'px;--jcs-m-shifty:'+s.mobileHeadingShiftY+'px;line-height:'+s.headingLineHeight+';margin-bottom:'+s.gapHeading+'px;--jcs-m-gap:'+mGapHeading+'px;--jcs-m-size:'+mHeadingSize+'px;">'+esc(normalizeStoredText(s.heading)).replace(/\n/g,'<br>')+'</div>\n' +
      '          <div class="csx-sub" style="color:'+s.subColor+'!important;font-family:'+s.bodyFont+',sans-serif!important;font-weight:'+s.bodyWeight+'!important;font-size:'+s.subSize+'px!important;letter-spacing:'+s.subLetterSpacing+'px!important;transform:translate('+s.subShiftX+'px,'+s.subShiftY+'px)!important;--jcs-m-letter:'+s.mobileSubLetterSpacing+'px;--jcs-m-shiftx:'+s.mobileSubShiftX+'px;--jcs-m-shifty:'+s.mobileSubShiftY+'px;line-height:'+s.subLineHeight+';margin-bottom:'+s.gapSub+'px;--jcs-m-gap:'+mGapSub+'px;--jcs-m-size:'+mSubSize+'px;">'+esc(normalizeStoredText(s.subheading)).replace(/\n/g,'<br>')+'</div>\n' +
      '          <a href="'+esc(s.buttonUrl)+'"'+(s.buttonNewTab?' target="_blank" rel="noopener noreferrer"':'')+' class="csx-button" style="background:'+(s.buttonBgEnabled===false?'transparent':'rgba('+hexRgb(s.buttonBg)+','+(s.buttonOpacity/100)+')')+'!important;color:'+s.buttonColor+'!important;padding:0 '+s.buttonPadX+'px!important;font-family:'+s.buttonFont+',sans-serif!important;font-weight:'+s.buttonWeight+'!important;font-size:'+s.buttonFontSize+'px!important;line-height:1!important;letter-spacing:'+s.buttonLetterSpacing+'px!important;transform:translate('+s.buttonShiftX+'px,'+s.buttonShiftY+'px)!important;width:'+(s.buttonWidth>0?s.buttonWidth+'px':'auto')+';--jcs-m-size:'+mButtonFontSize+'px;--jcs-m-letter:'+s.mobileButtonLetterSpacing+'px;--jcs-m-shiftx:'+s.mobileButtonShiftX+'px;--jcs-m-shifty:'+s.mobileButtonShiftY+'px;--jcs-m-width:'+(s.mobileButtonWidth>0?s.mobileButtonWidth+'px':'auto')+';min-height:'+s.buttonHeight+'px;border-radius:'+s.buttonRadius+'px;box-shadow:'+buttonShadow+';transition:background .15s ease, color .15s ease;">'+esc(s.buttonText)+'</a>\n' +
      '        </div>\n' +
      '      </div>\n' +
      '    </article>';
  }
...
'#'+instanceId+' .csx-prev{left:20px!important;right:auto!important}#'+instanceId+' .csx-next{right:20px!important;left:auto!important}\n' +
...
'  #'+instanceId+' .csx-arrow{top:auto!important;bottom:18px!important;transform:none!important}\n' +
'  #'+instanceId+' .csx-prev{left:auto!important;right:82px!important}#'+instanceId+' .csx-next{right:26px!important;left:auto!important}\n' +
'}\n' +
